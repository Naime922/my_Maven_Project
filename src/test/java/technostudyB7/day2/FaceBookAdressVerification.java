...
public class FaceBookAdressVerification {
    public static void main(String[] args) {
        ...
        String email="naimends@outlook.com";
        ...
        //<button value="1" class="_42ft _4jy0 _6lth _4jy6 _4jy1 selected _51sy" name="login" data-testid="royal_login_button" type="submit" id="u_0_5_Yt">Log In</button>
